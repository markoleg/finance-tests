...
FORMULY_CARD = ('<a class="card" style="--c:#16a34a;--cd:#15803d" href="formulas.html">'
  ...
  '<div class="cd">Формульний лист за розділами 1–2 програми · фінансова звітність (НП(С)БО) та фінансовий аналіз · з пошуком і поясненнями</div>'
  '<div class="cb">Позначення · Розділ 1 · Розділ 2 · шаблони задач · чек-лист</div>'
